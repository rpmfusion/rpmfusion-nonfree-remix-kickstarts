...
repo --name=rpmfusion-nonfree --mirrorlist=http://mirrors.rpmfusion.org/mirrorlist?repo=nonfree-fedora-17&arch=$basearch --includepkgs=rpmfusion-nonfree-release
# To include updates, use the following "repo"
repo --name=rpmfusion-nonfree-updates --mirrorlist=http://mirrors.rpmfusion.org/mirrorlist?repo=nonfree-fedora-updates-released-17&arch=$basearch --includepkgs=rpmfusion-nonfree-release
